...
@section('content')
    <div class="row">
        <div class="col-12 col-md-8 col-lg-12 col-xxl-4 order-0 order-md-0">
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                <div class="avatar flex-shrink-0">
                                    <img src="{{ asset('assets/img/icons/people.png') }}" alt="total users"
                                        class="rounded">
                                </div>
                            </div>
        ...
        <div class="col-xxl-8 mb-6 order-1">
            <div class="card">
        ...
        <!-- Total Revenue -->
        <div class="col-12 col-xxl-8 order-3 order-md-3 order-xxl-3 mb-6">
            <div class="card">
        ...
        <!--/ Total Revenue -->
        <div class="col-12 col-md-8 col-lg-12 col-xxl-4 order-4 order-md-4">
            <div class="row">
